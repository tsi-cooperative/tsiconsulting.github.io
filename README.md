...
An <a href="https://github.com/tsiconsulting/tsi-accelerator">open source backend-as-a-service solution</a> that enable organizations across diverse sectors such as finance, health, agriculture, manufacturing, skill development and commerce go digital quickly and capture new value from technologies such as mobile, cloud, data engineering, AI/ML etc
